...
### 📝 Documentación
- Actualización de `TESTING.md` para incluir cobertura de `test_market_data_ingest.py`.
- Clarificación de la imagen Docker `market-oracle` en `INFRASTRUCTURE.md`.

### 🐛 Correcciones
- Mantenimiento general y merge de la rama principal.
